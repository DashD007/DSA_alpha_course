public class lecture_216 {
    ...
    public static void main(String[] args) {
        ...
        //step 3: now we will modift our code so that it will only the no. of ways through which we can solve the problem
        ...
        //time complexity of n queens is O(n!) ..if we use isSafe() function;
        // else time complexity of n queens is O(n^n);
    }
}
